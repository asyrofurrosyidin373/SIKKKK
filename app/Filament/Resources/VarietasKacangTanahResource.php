...
// 10. VarietasKacangTanahResource.php
namespace App\Filament\Resources;

use App\Filament\Resources\VarietasKacangTanahResource\Pages;
...
class VarietasKacangTanahResource extends Resource
{
    protected static ?string $model = VarietasKacangTanah::class;
    protected static ?string $navigationIcon = 'heroicon-o-sparkles';
    protected static ?string $navigationGroup = 'OPT & Varietas';
    protected static ?string $navigationLabel = 'Varietas Kacang Tanah';
    ...
    {
        return [
            'index' => Pages\ListVarietasKacangTanahs::route('/'),
            'create' => Pages\CreateVarietasKacangTanah::route('/create'),
            'edit' => Pages\EditVarietasKacangTanah::route('/{record}/edit'),
        ];
    }
}
