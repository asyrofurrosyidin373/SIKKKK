...
// 5. KomKedelaiResource.php
namespace App\Filament\Resources;

use App\Filament\Resources\KomKedelaiResource\Pages;
...
class KomKedelaiResource extends Resource
{
    protected static ?string $model = KomKedelai::class;
    ...
    {
        return [
            'index' => Pages\ListKomKedelais::route('/'),
            'create' => Pages\CreateKomKedelai::route('/create'),
            'edit' => Pages\EditKomKedelai::route('/{record}/edit'),
        ];
    }
}
