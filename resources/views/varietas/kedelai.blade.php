{{-- resources/views/varietas/kedelai.blade.php --}}
@extends('layouts.app')

@section('title', 'Varietas Kedelai')
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-fill position-relative">
                                                    <input type="range" name="tahun" class="form-range" min="2000"
                                                        max="2025" value="{{ request('tahun', 2000) }}" id="rangeThun"
                                                        style="height: 10px;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex flex-column gap-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-fill position-relative">
                                                    <input type="range" name="bobot_biji" class="form-range"
                                                        min="0" max="50"
                                                        value="{{ request('bobot_biji', 0) }}" id="rangeBobot"
                                                        style="height: 8px;">
                                                    <div class="d-flex justify-content-between mt-2">
                                                        <small class="text-muted">0</small>
                                                        <small class="text-muted">1 g/100biji</small>
                                                    </div>
                                                    <div class="mt-1">
                                                        <small class="text-success fw-bold">Nilai: <span
                                                                id="bobotValue">{{ request('bobot_biji', 0) }}</span>
                                                            g/100biji</small>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-fill position-relative">
                                                    <input type="range" name="kadar_protein_range" class="form-range"
                                                        min="0" max="50"
                                                        value="{{ request('kadar_protein_range', 0) }}" id="rangeProtein"
                                                        style="height: 8px;">
                                                    <div class="d-flex justify-content-between mt-2">
                                                        <small class="text-muted">0</small>
                                                    ...
                                                    <div class="mt-1">
                                                        <small class="text-success fw-bold">Nilai: <span
                                                                id="proteinValue">{{ request('kadar_protein_range', 0) }}</span>%</small>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-fill position-relative">
                                                    <input type="range" name="kadar_lemak_range" class="form-range"
                                                        min="0" max="50"
                                                        value="{{ request('kadar_lemak_range', 0) }}" id="rangeLemak"
                                                        style="height: 8px;">
                                                    <div class="d-flex justify-content-between mt-2">
                                                        <small class="text-muted">0</small>
                                                        <small class="text-muted">(%)</small>
                                                    ...
                                                    <div class="mt-1">
                                                        <small class="text-success fw-bold">Nilai: <span
                                                                id="lemakValue">{{ request('kadar_lemak_range', 0) }}</span>%</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row g-2 mb-3">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <strong>{{ $item->bobot_biji }} g/100biji</strong>
                                                        </div>
                                                        <div class="col-6">
                                                    ...
                                                    @if ($item->keterangan_umum)
                                                        <div class="mt-3">
                                                            ...
                                                            <p class="small mb-0">
                                                                {{ Str::limit($item->keterangan_umum, 100) }}</p>
                                                        </div>
                                                    @endif
                                                </div>
        ...
        @else
            <div class="col-12">
                <div class="text-center py-5">
                    ...
                    <h5 class="text-muted">Gunakan filter di atas untuk mencari varietas kedelai</h5>
    ...
    @push('scripts')
        <script>
            ...
            function viewDetail(id) {
                window.location.href = `/varietas/kedelai/${id}`;
            }
        </script>
    @endpush
@endsection
