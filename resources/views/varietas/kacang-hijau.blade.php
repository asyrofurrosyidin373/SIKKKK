{{-- resources/views/varietas/kacang-hijau.blade.php --}}
@extends('layouts.app')

@section('title', 'Varietas Kacang Hijau')
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <div>
                        <h1 class="h2 text-success"><i class="fas fa-seedling me-2"></i>Varietas Kacang Hijau</h1>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="container-fluid px-0">
                                        ...
                                        <div class="d-flex flex-column gap-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-fill position-relative">
                                                    ...
                                                    <div class="d-flex justify-content-between mt-2">
                                                        <small class="text-muted">0</small>
                                                        <small class="text-muted">50 g/100biji</small>
                                                    </div>
                                                    <div class="mt-1">
                                                        <small class="text-success fw-bold">Nilai: <span
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-center">
                                        <a href="{{ route('varietas.kacang-hijau') }}"
        ...
        @else
            <div class="col-12">
                <div class="text-center py-5">
                    ...
                    <h5 class="text-muted">Gunakan filter di atas untuk mencari varietas kacang hijau</h5>
    ...
    @push('scripts')
        <script>
            ...
            function viewDetail(id) {
                window.location.href = `/varietas/kacang-hijau/${id}`;
            }
        </script>
    @endpush
@endsection